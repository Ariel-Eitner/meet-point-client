    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-wrap items-center mt-2">
        <div className="w-full md:w-1/2 p-4">
          ...
          <p className="mt-4">
            Meet Point no es solo una plataforma en línea; es una revolución en
            el acceso que une a pacientes y profesionales en un entorno digital
            seguro y amigable. Descubre lo que puedes hacer en Meet Point:
          </p>
